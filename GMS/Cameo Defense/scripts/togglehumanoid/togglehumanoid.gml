	...
	switch (option_humanoid)
	{
				...
				{
				    {
						...
						if ds_grid_get(file_grid, 8, j) = "0"{
		...
		case "1":
				...
				for (var j = 0; j < hh; j++;)
				{
				    {
						ds_grid_set(file_grid, ww, j, 0)
						if ds_grid_get(file_grid, 8, j) = "1"{
							ds_grid_set(file_grid, 5, j, 1)
						}
					}
				}
